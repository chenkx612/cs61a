...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    singles = player_score % 10
    tens = opponent_score % 100 // 10
    score = abs(singles - tens) * 3
    if score > 0:
        return score
    else:
        return 1
...
def sus_points(score):
    ...
    if num == 3 or num == 4:
        latest_prime = score + 1
        while is_prime(latest_prime) != True:
            latest_prime += 1
        return latest_prime 
    else:
        return score
...
def play(strategy0, strategy1, update,
    ...
    while True:
        if who == 0:
            ...
            strategy, score, opponent_score = strategy1, score1, score0
        num_rolls = strategy(score, opponent_score)
        score = update(num_rolls, score, opponent_score, dice)
        if who == 0:
            score0 = score
        else:
            score1 = score
...
def is_always_roll(strategy, goal=GOAL):
    ...
    """
    # BEGIN PROBLEM 7
    init_num = strategy(0, 0)
    for score in range(goal):
        for opponent_score in range(goal):
            if strategy(score, opponent_score) != init_num:
                return False
    return True
    # END PROBLEM 7
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    new_score = sus_points(score + boar_score)
    add_score = new_score - score
